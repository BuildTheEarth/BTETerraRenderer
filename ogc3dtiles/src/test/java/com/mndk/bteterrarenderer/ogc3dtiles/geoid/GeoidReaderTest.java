...
public class GeoidReaderTest {
    ...
    public void givenPOIs_testGeoidHeights() {
        ...
        Assertions.assertEquals(-34.65, function.getHeight(Spheroid3.fromDegrees(-80.014148, 40.441575, 0)), 0.01);
        Assertions.assertEquals(47.76, function.getHeight(Spheroid3.fromDegrees(-1.258417, 51.752439, 0)), 0.01);
        Assertions.assertEquals(43.09, function.getHeight(Spheroid3.fromDegrees(4.772462, 52.265339, 0)), 0.01);
        Assertions.assertEquals(22.76, function.getHeight(Spheroid3.fromDegrees(150.985325, -33.852682, 0)), 0.01);
        Assertions.assertEquals(31.03, function.getHeight(Spheroid3.fromDegrees(18.429578, -33.916120, 0)), 0.01);
        Assertions.assertEquals(36.63, function.getHeight(Spheroid3.fromDegrees(139.516599, 35.309069, 0)), 0.01);
    }
    ...
    public void givenGzippedDataFile_testChecksum() throws IOException, NoSuchAlgorithmException {
        ...
        try (InputStream stream = Egm96Ww15mghData.class.getResourceAsStream("WW15MGH.dat.gz");
            ...
            Assertions.assertEquals(1440 * 721 * 4, data.length);
        }
        ...
        for (int i = 0; i < actual.length; i++) {
            ...
            Assertions.assertEquals(expectedByte, actual[i]);
        }
    }
