...
import com.mndk.bteterrarenderer.mcconnector.dummy.DummyTextureManager;
...
import com.mndk.bteterrarenderer.mcconnector.dummy.DummyI18nManager;
...
public class TestEnvironmentDummyMinecraft extends ClientMinecraftManager {
    ...
    private TestEnvironmentDummyMinecraft(File gameDirectory) {
        super(null, new DummyTextureManager(), new DummyI18nManager(), null, null);
